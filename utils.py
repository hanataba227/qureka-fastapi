    ...
    prompts = {
        "내용 요약_기본 요약": {
            ...
            "user": f"""문서 전체를 분석하여 흐름을 파악하고, '서론-본론-결론'의 흐름으로 재구성하라.\n
                        ...
                        -[문서 분석]은 구성과 전개 흐름을 중심으로 '서론-본론-결론'의 흐름으로 구간별 핵심 내용을 요약한다.\n
        ...
        "문제 생성_n지 선다형": {
            ...
            "user": f'''학습자의 핵심 개념 이해, 용어 정의, 개념 간 비교 및 오류 식별 능력을 점검할 수 있도록 {choice_count}지선다형 문제를 생성하라. 이때, 혼동 가능한 오답을 포함해 학습자의 개념적 정확성과 구분 능력을 평가할 수 있도록 구성하라.\n
                        ...
                        -{choice_format}이 단답형인 경우, 보기의 형태를 문장이 아닌 단어 또는 짧은 구의 형태로 구성하며, 용어, 개념, 키워드 중심으로 마침표 없이 간결하게 작성하라. 단답형의 형태는 다음의 예시를 참고하라.\n
                         [n지 선다형의 단답형 예시]
                         문제1. '탄소 중립'을 실현하기 위한 국가 정책의 방향으로 적절한 것은?\n\n
                           1. 산업 성장 중심\n
                           2. 온실가스 감축\n
                           3. 화석연료 사용 유지\n
                           4. 온실가스 거래 축소\n\n
                        -{choice_format}이 문장형인 경우, 보기의 형태를 '주어+서술어' 구조의 완결된 문장으로 구성하고, 설명, 판단을 표현하며, 문장 끝에 마침표를 포함하라. 문장형의 형태는 다음의 예시를 참고하라.\n
                         [n지 선다형의 문장형 예시]
                          문제1. '탄소 중립'을 실현하기 위한 국가 정책의 방향으로 적절한 것은?\n\n
                           1. 산림 보호보다는 산업 성장에 집중한다.\n
                           2. 온실가스 배출을 줄이되 에너지 수요는 유지한다.\n
